...
/// 来自开源库的UI并不符合我的需求，所以拉下源代码进行魔改

///Code starts here
class CalendarAppBarV2 extends StatefulWidget implements PreferredSizeWidget {
  ///accent color of UI
  final Color? accent;
  ...
  ///initialization of [CalendarAppBarV2]
  CalendarAppBarV2({
    Key? key,
  ...
  ///creating state
  CalendarAppBarV2State createState() => CalendarAppBarV2State();
...
class CalendarAppBarV2State extends State<CalendarAppBarV2> {
        ...
        child: NotificationListener(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                // 找日期相同的
                bool isSelected = formatDate(selectedDate, dateFormatYMD) == formatDate(date, dateFormatYMD);
